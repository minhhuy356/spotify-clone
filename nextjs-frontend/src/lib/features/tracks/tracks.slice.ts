...
export const tracksSlice = createSlice({
  ...
  reducers: {
    ...
    setPlayingSource(state, action: PayloadAction<IPlayingSource>) {
      if (action.payload) {
        state.playingSource._id = action.payload._id;
        state.playingSource.before = action.payload.before;
        state.playingSource.title = action.payload.title;
        state.playingSource.in = action.payload.in;
      }
    },
