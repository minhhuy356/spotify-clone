...
export const localSlice = createSlice({
  ...
  reducers: {
    ...
    setOpenContextMenuArtist(
      ...
      if (action.payload.temporaryArtist !== undefined) {
    ...
    setOpenContextMenuAlbum(
      ...
      if (action.payload.temporaryAlbum !== undefined) {
    ...
    setOpenContextMenuPlaylist(
      ...
      if (action.payload.temporaryPlaylist !== undefined) {
    ...
    setOpenContextMenuFolder(
      ...
      if (action.payload.temporaryFolder !== undefined) {
