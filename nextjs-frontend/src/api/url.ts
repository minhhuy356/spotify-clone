...
export const api_track_artists = {
  ...
  albumByArtist: `${url_api_track_artists}albumByArtist/`,
};
...
export const api_tracks = {
  ...
  releasedBy: `${url_api_tracks}releasedBy/`,
};
...
export const api_user_activity = {
  ...
  propose: `${url_api_user_activity}propose/`,
  artistAlsoLiked: `${url_api_user_activity}artistAlsoLiked/`,
};

export const url_api_albums = "api/v1/albums/";
export const api_albums = {
  related: `${url_api_albums}related/`,
  releasedBy: `${url_api_albums}releasedBy/`,
};
...
export const url_api_listening_historys = "api/v1/listening-historys/";
export const api_listening_historys = {
  trending: `${url_api_listening_historys}trending`,
  recently: `${url_api_listening_historys}recently`,
};
...
export const url_api_lyrics = "api/v1/lyrics/";
//**** DISK *** */
