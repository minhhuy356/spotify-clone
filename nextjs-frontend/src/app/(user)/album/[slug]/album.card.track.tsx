...
const AlbumCardTrack = ({
  ...
  const isSubscribedTrack =
    session?.user.tracks.some((item) => item._id === track._id) || false;

  return (
    <div
      className="grid grid-cols-[16px_5fr_1fr] items-center w-full h-[56px] px-4 group hover:bg-50 rounded gap-4"
