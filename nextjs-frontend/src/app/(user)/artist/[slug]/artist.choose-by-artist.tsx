    ...
    <div className="flex flex-col gap-4">
      ...
      {chooseByArtist.chooseTrack ? (
        <div className="w-[343px] h-[250px] relative">
          ...
          <div className="absolute z-10 bottom-4 right-4 top-4 left-4 flex flex-col justify-between ">
        ...
        <div className="flex gap-4">
          <div className="">
            <img
              src={`${backendUrl}${disk_tracks.images}${chooseByArtist.chooseAlbum.imgUrl}`}
              alt=""
              className="size-[88px] rounded"
            />
          </div>
          <div className="flex flex-col gap-2">
            <div className="flex gap-2 items-center">
              ...
              <span className="text-white-06">
                Đăng bởi {chooseByArtist.artist.stageName}
              </span>
            </div>
            <div className="flex flex-col font-bold">
              <span className="text-xl">{chooseByArtist.chooseAlbum.name}</span>
              <span className="text-white-06">
                {convertTypeAlbum(chooseByArtist.chooseAlbum.type)}
              </span>
            </div>
          </div>
        </div>
