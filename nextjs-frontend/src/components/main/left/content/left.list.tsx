      ...
      <ModalCustom
        ...
        onConfirm={async () => {
          if (temporaryFolder) {
            ...
            dispatch(setTemporaryFolder({ temporaryFolder: undefined }));
      ...
      <ModalCustom
        ...
        onConfirm={async () => {
          if (temporaryPlaylist) {
            ...
            dispatch(setTemporaryPlaylist({ temporaryPlaylist: undefined }));
      ...
      <ModalCustom
        ...
        onConfirm={async () => {
          if (temporaryAlbum) {
            ...
            dispatch(setTemporaryAlbum({ temporaryAlbum: undefined }));
      ...
      <ModalCustom
        ...
        onConfirm={async () => {
          if (temporaryArtist) {
            ...
            dispatch(setTemporaryArtist({ temporaryArtist: undefined }));
