...
const Right = (props: IProps) => {
  const { fatherRef, layoutState, updateLayout } = props;
  ...
  return (
    <div className={` ${layoutState.right.width <= 42 ? "hidden " : "block"}`}>
      <div className={`overflow-hidden rounded-lg group `}>
        ...
        >
          <div className="relative">
            ...
            <div className="relative ">
              <div
                className={`h-auto flex justify-center w-full rounded-lg overflow-hidden aspect-square ${
                ...
                <div className="flex justify-between items-center relative">
                  ...
                  >
                    <div className="flex ">
                      <Marquee>
                        <Link
                          href={`${frontendUrl}${router_track}${currentTrack._id}`}
                    ...
                    >
                      <Marquee>
                        <>
                          <Link
                            href={`${frontendUrl}${router_artist}${currentTrack.releasedBy._id}`}
                            ...
                            .map((artists: any, index: any, self: any) => {
                              ...
                              return !isDuplicate ? (
                                <span key={artists.artist._id}>
                                  {", "}
                                  <Link
                                    href={`${frontendUrl}${router_artist}${artists.artist._id}`}
                                    className="hover:underline hover:text-white"
                                  >
                                    {artists.artist.stageName}
                                  </Link>
            ...
            <div
              ...
              onClick={() => {
                ...
                updateLayout({
                  ...
                  center: initialWidth - layoutState.left.width - 0 - space,
                });
              }}
            >
              <IoClose size={20} />
