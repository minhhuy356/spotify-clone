...
export class TracksController {
  ...
  @Public()
  @Post('skip')
  checkSkip(@Body() body: { trackId: string; durationPresent: number }) {
    return this.trackService.checkSkip(body);
  }
  ...
  @Public()
  @Get('releasedBy/:id')
  fetchTracksByReleasedBy(
    @Param('id') id: string,
    @Query() query: TrackQueryDto,
  ) {
    return this.trackService.fetchTracksByReleasedBy(id, {
      ...query,
  ...
  @Cron('0 */30 * * * *')
  updateTrackScores() {
    return this.trackService.updateTrackScores();
  }

  @Cron('0 */30 * * * *')
  @Public()
  updateAlbumScores() {
    return this.trackService.updateAlbumScores();
  }
}
